...
##@ [Gateway Asaas]
asaas: ## Run resource asaas. Apply arguments via make asaas ARGS="charge|customer|pix|webhook"
	@docker compose exec -it app php examples/asaas/$(resource).php